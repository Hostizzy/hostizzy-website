                ...
                <div className="container" style={{ position: 'relative', zIndex: 1 }}>
                    <ScrollReveal>
                        <div style={{ maxWidth: '720px', margin: '0 auto', textAlign: 'center', paddingBottom: '3rem' }}>
                            ...
                            <h1 style={{ fontSize: 'clamp(2.4rem, 5vw, 3.75rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: '1.25rem', letterSpacing: '-0.02em' }}>
                    ...
                    <ScrollReveal delay={0.15}>
                        <div style={{
                            ...
                            <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                <Briefcase size={16} style={{ color: '#3b82f6' }} /> <strong style={{ color: '#fff' }}>5</strong> Open Roles
                            </span>
                            <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <ScrollReveal>
                        <div style={{ marginBottom: '2rem' }}>
                            ...
                            <p style={{ color: '#64748b', fontSize: '0.95rem' }}>
                                {filteredOpenings.length} role{filteredOpenings.length !== 1 ? 's' : ''} available
                            </p>
                        </div>
                    </ScrollReveal>
                                        ...
                                        <div style={{ flex: 1, minWidth: '260px' }}>
                                            ...
                                            <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '0.75rem', flexWrap: 'wrap' }}>
                                                ...
                                                <span style={{
                                                    ...
                                                    <Briefcase size={12} /> {job.exp}
                                                </span>
                                            </div>

                                            {/* Desc */}
                                            <p style={{ color: '#475569', lineHeight: 1.6, fontSize: '0.92rem', margin: 0 }}>{job.desc}</p>
                    ...
                    <ScrollReveal>
                        <div>
                            <span style={{
                                ...
                                letterSpacing: '0.1em', color: '#3b82f6', marginBottom: '0.75rem', display: 'block'
                            }}>
                                Life at Hostizzy
                            </span>
                            ...
                            <p style={{ color: '#64748b', lineHeight: 1.75, fontSize: '1.05rem', marginBottom: '1.5rem' }}>
                            ...
                            <p style={{ color: '#64748b', lineHeight: 1.75, fontSize: '1.05rem' }}>
                                From unlimited chai to team offsites at our own properties, we invest in making work genuinely enjoyable.
                            </p>
                        </div>
                    </ScrollReveal>

                    {/* Right: culture cards grid */}
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                        {perks.slice(0, 4).map((perk, i) => (
                            <ScrollReveal key={i} delay={i * 0.08}>
                                ...
                                >
                                    <div style={{ color: '#3b82f6', marginBottom: '0.6rem' }}>{perk.icon}</div>
                                    <h4 style={{ fontSize: '0.95rem', fontWeight: 700, marginBottom: '0.35rem' }}>{perk.title}</h4>
                                    <p style={{ color: '#64748b', fontSize: '0.82rem', lineHeight: 1.55, margin: 0 }}>{perk.text}</p>
                                </div>
                            </ScrollReveal>
                        ))}
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem', flexWrap: 'wrap' }}>
                        {perks.slice(4).map((perk, i) => (
                            <ScrollReveal key={i} delay={0.3 + i * 0.08}>
                                <div style={{
                                    background: '#fff', borderRadius: '12px', padding: '1.25rem',
                                    border: '1px solid #e2e8f0', flex: '1 1 260px', maxWidth: '360px',
                                    transition: 'box-shadow 0.2s ease'
                                }}
                                    onMouseEnter={e => e.currentTarget.style.boxShadow = '0 4px 20px rgba(0,0,0,0.06)'}
                                    onMouseLeave={e => e.currentTarget.style.boxShadow = 'none'}
