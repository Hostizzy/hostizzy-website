...
export async function POST(request) {
  try {
    ...
    const prompt = `You are an expert vacation rental revenue analyst specializing in the Indian market. Analyze this property and provide realistic revenue estimates.
...
2. Realistic annual occupancy percentage (India vacation rentals typically range 45-80%)
3. Annual gross revenue
4. Net income after expenses (assume: 20% management fee, 18% OTA commissions, 15% operations = 53% total expenses)
5. A confidence score from 1-10
6. Monthly seasonal demand trend (12 values, 1-100 scale where 100 is peak)
7. A brief 2-sentence market insight
8. 3 actionable recommendations

IMPORTANT: Be realistic and conservative. Base estimates on actual Indian market rates. A 3BHK villa in Goa typically gets ₹8,000-15,000/night. A 2BHK apartment in Manali gets ₹4,000-8,000/night. Adjust proportionally.
