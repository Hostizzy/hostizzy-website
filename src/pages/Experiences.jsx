...
const Experiences = () => {
    ...
    return (
        <>
            <SEO
                title="NextStop: Curated Group Trips & Experiences by Hostizzy"
                description="Join NextStop by Hostizzy for curated group travel experiences. Manali New Year Bash, Goa Wellness Retreats, and more. Travel with a community."
            />
