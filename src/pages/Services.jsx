...
const Services = () => {
    ...
    const steps = [
        ...
        { title: "Go Live & Manage", desc: "We handle channels, guests, and operations seamlessy." },
        ...
        <>
                        ...
                        <ScrollReveal key={i} delay={i * 0.1}>
                            <div className="card glass" style={{ padding: '2rem', height: '100%' }}>
                                ...
                                <div style={{ marginTop: '1.5rem', paddingTop: '1rem', borderTop: '1px solid #e2e8f0', textAlign: 'center' }}>
                                    <Link to="/contact" style={{ fontSize: '0.9rem', fontWeight: 600, color: 'var(--color-primary)' }}>Add to Plan →</Link>
                                </div>
                            </div>
                        </ScrollReveal>
                    ))}
                ...
                <ScrollReveal>
                    <div className="card shadow-premium" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #334155 100%)', color: 'white', padding: '4rem 2rem', textAlign: 'center', borderRadius: '2rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                            ...
                            <Link to="/contact" className="btn btn-outline" style={{ borderColor: 'white', color: 'white' }}>List Your Property</Link>
                        </div>
                    </div>
                </ScrollReveal>
            </section>
            ...
            <section className="section text-center" style={{ padding: '4rem 0' }}>
                <div className="container">
                    ...
                    <Link to="/contact" className="btn btn-primary" style={{ padding: '1rem 3rem', fontSize: '1.1rem' }}>Schedule Discovery Call</Link>
                </div>
            </section>
        </>
    );
